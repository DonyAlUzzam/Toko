...
<table width="100%" border="0" id="table1">
    <?php
include "KONEKSI.php";
$oke=mysql_query("select * from options where option_name='blogname' ");
...
$oke=mysql_query("select * from options where option_name='siteurl'");
while($data=mysql_fetch_array($oke)){
echo"<tr>
...
$oke=mysql_query("select * from options where option_name='description'");
while($data=mysql_fetch_array($oke)){
echo"<tr>
