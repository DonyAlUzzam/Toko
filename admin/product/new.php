...
$data=mysql_query ("INSERT INTO product VALUES ('','$code','$name','$category','$description','$price','$size','$color','$status',now(),'$stock','$fotobaru','$_SESSION[username]') ") or die (mysql_error());
if ($data){
